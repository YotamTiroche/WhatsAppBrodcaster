...
# Setup Variables
message_filename = 'message.txt' # Enter desired message filename here
contacts_filename = 'purimatlanta-Participants_googleformat.csv' # Enter contacts CSV filename here
